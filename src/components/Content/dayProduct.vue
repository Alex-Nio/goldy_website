...
<script>
import dayProductSlider from "@/components/DayProduct/dayProductSlider";
export default {
  data() {
    return {
      dpData: [
        {
          ...
          previewImages: [
            { 0: "assets/img/dayProduct/slide1.png" },
            { 1: "assets/img/dayProduct/slide1.png" },
            { 2: "assets/img/dayProduct/slide1.png" },
          ],
          sizes: [
            { active: "16,5" },
            { active: "17,5" },
        ...
        },
        {
          ...
          discount: "21 000 ₽",
          label: "-25%",
          description: "Серьга из золота с бриллиантами",
          colors: [
            { active: "gray" },
            { active: "gold" },
            { active: "orange" },
        ...
        },
        {
          ...
          discount: "22 000 ₽",
          label: "-45%",
          description: "Браслет с бриллиантами",
          colors: [
            { active: "gray" },
            { active: "gold" },
            { active: "orange" },
        ...
        },
        {
          ...
          discount: "22 000 ₽",
          label: "-45%",
          description: "Серьга с бриллиантами",
          colors: [
            { active: "gray" },
            { active: "gold" },
            { active: "orange" },
        ...
        },
        {
          ...
          discount: "22 000 ₽",
          label: "-45%",
          description: "Часы с бриллиантами",
          colors: [
            { active: "gray" },
            { active: "gold" },
            { active: "orange" },
